  ...
  if (part.functionCall) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(part.functionCall, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
  if (part.functionResponse) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(part.functionResponse, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
...
const RenderSystemInstruction = memo(({ systemInstruction, defaultExpanded = true }: { systemInstruction: ContentUnion; defaultExpanded?: boolean }) => {
  ...
  return (
    ...
    >
      <JsonCodeBlock
        language="json"
        code={JSON.stringify(systemInstruction, null, "  ")}
      />
    </CollapsibleLogPart>
  );
});
  ...
  if (tool.functionDeclarations) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(tool.functionDeclarations, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
  if (tool.googleSearch) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(tool.googleSearch, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
  if (tool.googleMaps) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(tool.googleMaps, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
  if (tool.urlContext) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(tool.urlContext, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
  if (tool.codeExecution) {
    return (
      ...
      >
        <JsonCodeBlock
          language="json"
          code={JSON.stringify(tool.codeExecution, null, "  ")}
        />
      </CollapsibleLogPart>
    );
  }
